...
//   const [receivedMessages, setReceivedMessages] = useState([]); // System messages
...
//           return newMessages.slice(-8); // Keep latest 8 messages
//         });
//       } else {
...
//       setMessages([...messages, msg].slice(-8)); // Keep latest 8 messages
